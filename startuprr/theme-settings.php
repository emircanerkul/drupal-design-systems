...
/**
 * @file
 * Theme settings form for startuprr theme.
 */

/**
 * Implements hook_form_system_theme_settings_alter().
 */
function startuprr_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['general']['contact_background'] = [
    '#type' => 'managed_file',
    '#title' => 'Contact Section Background',
    '#upload_validators' => [
      'file_validate_extensions' => ['png jpg jpeg webp'],
      'file_validate_size' => [1024 * 1024 * 4],
    ],
    '#default_value' => theme_get_setting('contact_background'),
  ];

  $form['general']['question_text'] = [
    '#type' => 'textfield',
    '#title' => t('Question Text'),
    '#default_value' => theme_get_setting('question_text'),
  ];

  $form['general']['question_purchase_url'] = [
    '#type' => 'textfield',
    '#title' => t('Question Purchase URL'),
    '#default_value' => theme_get_setting('question_purchase_url'),
  ];

  $form['general']['copyright_text'] = [
    '#type' => 'textfield',
  ...
  $form['what_we_offer']['what_we_offer_description'] = [
    '#type' => 'textfield',
    '#title' => t('What We Offer Description'),
    '#default_value' => theme_get_setting('what_we_offer_description'),
  ];

  for ($i = 1; $i < 4; $i++) {
    $form['what_we_offer']["what_we_offer_box_$i"] = [
      '#type' => 'details',
      '#title' => "What We Offer Box #$i",
      '#open' => $i == 1,
    ];

    $form['what_we_offer']["what_we_offer_box_$i"]["what_we_offer_box_icon_$i"] = [
      '#type' => 'select',
      '#title' => t('Icon'),
      '#options' => get_font_awesome_options(),
      '#empty_option' => t('- Select Icon -'),
      '#default_value' => theme_get_setting("what_we_offer_box_icon_$i"),
    ];

    $form['what_we_offer']["what_we_offer_box_$i"]["what_we_offer_box_title_$i"] = [
      '#type' => 'textfield',
      '#title' => t('Title'),
      '#default_value' => theme_get_setting("what_we_offer_box_title_$i"),
    ];

    $form['what_we_offer']["what_we_offer_box_$i"]["what_we_offer_box_desc_$i"] = [
      '#type' => 'textfield',
      '#title' => t('Description'),
      '#default_value' => theme_get_setting("what_we_offer_box_desc_$i"),
    ];
  }

  $form['company_facts'] = [
    '#type' => 'details',
    '#title' => t('Section: Company Facts'),
    '#group' => 'startuprr',
  ];

  $form['company_facts']['company_facts_description'] = [
    '#type' => 'textfield',
    '#title' => t('What We Offer Description'),
    '#default_value' => theme_get_setting('company_facts_description'),
  ];

  for ($i = 1; $i < 5; $i++) {
    $form['company_facts']["company_facts_box_$i"] = [
      '#type' => 'details',
      '#title' => "Company Facts Box #$i",
      '#open' => $i == 1,
    ];

    $form['company_facts']["company_facts_box_$i"]["company_facts_box_number_$i"] = [
      '#type' => 'number',
      '#min' => 0,
      '#max' => 9999999,
      '#title' => t('Number'),
      '#default_value' => theme_get_setting("company_facts_box_number_$i"),
    ];

    $form['company_facts']["company_facts_box_$i"]["company_facts_box_icon_$i"] = [
      '#type' => 'select',
      '#title' => t('Icon'),
      '#options' => get_font_awesome_options(),
      '#empty_option' => t('- Select Icon -'),
      '#default_value' => theme_get_setting("company_facts_box_icon_$i"),
    ];

    $form['company_facts']["company_facts_box_$i"]["company_facts_box_title_$i"] = [
      '#type' => 'textfield',
      '#title' => t('Title'),
      '#default_value' => theme_get_setting("company_facts_box_title_$i"),
    ];
  }
...
/**
 * Returns Font Awesome Options for Select Typed Input.
 */
function get_font_awesome_options() {
  $icons = [
    'glass' => 'glass',
    'music' => 'music',
    'search' => 'search',
